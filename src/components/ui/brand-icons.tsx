...
/**
 * Brand glyphs for GitHub and LinkedIn.
 *
 * Lucide removed logo/brand icons for trademark reasons, so we ship minimal
 * inline SVGs here. These accept a `className` for sizing and currentColor fill.
 */
